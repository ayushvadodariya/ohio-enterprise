...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary text-white py-12 mt-16 font-sans font-medium">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                <p className="text-xs uppercase tracking-widest font-semibold mb-1 text-secondary">GST Number</p>
